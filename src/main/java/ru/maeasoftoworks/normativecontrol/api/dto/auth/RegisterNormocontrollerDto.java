...
public class RegisterNormocontrollerDto {
    @Schema(description = "Адрес электронной почты, к которому будет привязана учётная запись", example = "m.v.stolyarov@urfu.me")
    ...
    @Schema(description = "Пароль, по которому будет осуществляться доступ к учётной записи", example = "St0ly4r0v_p4ssw0rd_8764")
